...
import { X, ArrowRight, Receipt, Signal, CreditCard } from "lucide-react";
    ...
    <div className="mx-auto max-w-md font-sans">
      <motion.div
        ...
        animate={{
          ...
          width: selectedTransaction ? 300 : 300,
          // scaleY: selectedTransaction ? 0.85 : 1,
        }}
          ...
          {!selectedTransaction ? (
            ...
            >
                  ...
                  >
                    <div className="flex items-center space-x-1">
                      ...
                      <div>
                        ...
                        <motion.p layoutId={`type-${transaction.id}`} className="text-sm text-gray-400">
                          {transaction.type}
                        </motion.p>
                      </div>
                    </div>
                    <motion.p layoutId={`amount-${transaction.id}`} className="font-bold text-gray-400">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="m-auto flex w-11/12 items-center justify-center rounded-xl bg-gray-100 py-2 text-gray-800"
              >
